...
const HeroSection = () => {
    return(
        <section
        id="home"
        className="bg-gradient-to-b from-emerald-950 from-1% via-green-900 via-90% to-green-950 relative overflow-hidden z-10 pt-[120px] pb-[110px] md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
