        ...
        <div className="bg-gradient-to-b from-white via-[#eefff3] to-[#e4ffec] py-12">
            ...
            <div className="footer">
                ...
                <div className="social-container flex flex-row justify-center space-x-4">
                    ...
                    <a href="#your-link" className="rounded-full bg-white shadow-md flex justify-center items-center w-16 h-16">
                        <svg className="object-contain w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 16 16">
